...
public class BD {
    ...
    private static final String BD_FILE_NAME = "PVCorrector.db";
    private InputStream  BD_DDL_BD=BD.class.getResourceAsStream("/dataBase.sql");
    ...
    private void leerDDL() {
        ...
        try {
            br = new BufferedReader(new InputStreamReader(BD_DDL_BD));
